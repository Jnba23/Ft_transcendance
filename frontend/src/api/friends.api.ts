...
export const friendsApi = {
  createFriendRequest: async (data: CreateFriendRequestReq) => {
    const response = await client.post<CreateFriendRequestRes>(
      '/friends/requests',
      data
    );
  ...
  getFriendRequests: async (type: 'sent' | 'received') => {
    const response = await client.get<GetFriendRequestsRes>(
  ...
  updateFriendRequestStatus: async (data: UpdateFriendRequestStatusReq) => {
    const response = await client.post<UpdateFriendRequestStatusRes>(
