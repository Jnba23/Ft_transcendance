    ...
    >
      ...
      <div className="space-y-6 text-white/80 leading-relaxed">
        <section>
          ...
          <p>
            By accessing or using the ft_transcendence gaming platform, you
        ...
        <section>
          ...
          <p>
            ft_transcendence is an online multiplayer gaming platform (featuring
            games like Pong) that includes real-time communication, match
            tracking, and social features. The service is provided &quot;as
            is&quot; and may be updated, modified, or discontinued at any time
        ...
        <section>
          ...
          <p>
            ...
            safeguarding your password and any other credentials used to access
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <li>
              Use cheats, exploits, automation software, bots, hacks, mods, or
              any unauthorized third-party software designed to modify or
              interfere with the ft_transcendence experience.
            </li>
            <li>
          ...
          <p className="mt-2 text-[#E94560]">
            ...
            account and access to the platform without prior notice.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            All content, features, and functionality of ft_transcendence,
            including but not limited to design, text, graphics, logos, images,
            and software, are the exclusive property of its developers (students
            at 42 school) and are protected by copyright, trademark, and other
        ...
        <section>
          ...
          <p>
            In no event shall ft_transcendence, its developers, or its
            ...
            on the service; or (iii) unauthorized access, use or alteration of
        ...
        <section>
          ...
          <p>
            ...
            Material changes will be communicated through the platform. By
