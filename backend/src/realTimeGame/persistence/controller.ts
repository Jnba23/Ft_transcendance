...
import { getUserGameHistory, getUserGamesCount, getUserStats } from './gamePersistence.js';
...
export function getHistory(req: Request, res: Response) {
	...
	const games = getUserGameHistory(userId, page, limit, gameType as 'pong' | 'RPS');
